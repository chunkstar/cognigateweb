 ...
 * ```
 */
interface CloudProvidersConfig {
    /**
...
export { type BudgetStatus as B, type CompletionOptions as C, Gateway as G, type LocalFallbackConfig as L, type ProviderConfig as P, type WebhooksConfig as W, type GatewayConfig as a, type CompletionResult as b, type CloudProvidersConfig as c, type Provider as d, type CacheEntry as e };
